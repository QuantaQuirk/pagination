...
/**
 * @mixin \QuantaQuirk\Support\Collection
 */
abstract class AbstractCursorPaginator implements Htmlable
{
     ...
     * The current cursor.
     *
     * @var \QuantaQuirk\Pagination\Cursor|null
     */
    protected $cursor;
     ...
     * @param  bool  $isNext
     * @return \QuantaQuirk\Pagination\Cursor
     */
     ...
     *
     * @return \QuantaQuirk\Contracts\View\Factory
     */
